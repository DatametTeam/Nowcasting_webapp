...
# Data loaders
from nwc_webapp.data.loaders import load_prediction_data, read_groundtruth_and_target_data

# Coordinate transformations
from nwc_webapp.geo.coordinates import lat_0, lincol_2_radyx, lincol_2_yx, lon_0, map_, par, yx_2_latlon

# Shapefiles
from nwc_webapp.geo.shapefiles import SHAPEFILE_FOLDER, get_italian_region_shapefile, load_italy_shape
...
def generate_splotchy_image_main_(
    batch_size=24, channels=12, height=1400, width=1200, num_clusters=5, cluster_radius=100, min_value=0, max_value=100
):
    """
...
from nwc_webapp.visualization.figures import cmap, italy_shape, norm, ticks, vmax, vmin, x, y
